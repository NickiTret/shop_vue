          ...
          <div class="container">
            <div class="row multi-columns-row">
              <div class="col-sm-6 col-md-4 col-lg-4" v-for="item in products" :key="item.id">
                <div class="shop-item">
                  <div class="shop-item-image"><img :src="item.preview_image_url" alt="Accessories Pack"/>
                    <div class="shop-item-detail"><a class="btn btn-round btn-b"><span class="icon-basket">Добавить в корзину</span></a></div>
                  </div>
                  <h4 class="shop-item-title font-alt"><a href="#">{{ item.title }}</a></h4>{{ item.price }} RUB
                </div>
              </div>
            </div>
            <div class="row">
