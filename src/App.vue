      ...
      <router-view />
            ...
            <div class="row">
              <div class="col-sm-3">
                <div class="widget">
                  ...
                  <p>Языки отличаются только своей грамматикой, произношением и наиболее распространенными словами.</p>
                  ...
                  <ul class="widget-posts">
                    <li class="clearfix">
                      ...
                      <div class="widget-posts-body">
                        <div class="widget-posts-title"><a href="#">Дизайн старых технологий</a></div>
                    ...
                    <li class="clearfix">
                      ...
                      <div class="widget-posts-body">
                        <div class="widget-posts-title"><a href="#">Реалистичный бизнес дизайн</a></div>
        ...
        <footer class="footer bg-dark">
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                <p class="copyright font-alt">&copy; 2023&nbsp;<router-link to="/">NICKWEB</router-link>, ВСЕ ПРАВА ЗАЩИЩЕНЫ</p>
              </div>
              <div class="col-sm-6">
